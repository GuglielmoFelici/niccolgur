...
let QueueElementComponent = class QueueElementComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SeasonComponent = class SeasonComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let NiccolgurManagerService = class NiccolgurManagerService {
    constructor(niccolgurService) {
        this.niccolgurService = niccolgurService;
    }
    getUsers() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const queue = yield this.niccolgurService.getQueue().toPromise();
            const users = yield this.niccolgurService.getUsers().toPromise();
            return queue.map(u => users.find(el => el.id === u));
        });
    }
};
NiccolgurManagerService.ctorParameters = () => [
...
let NiccolgurService = class NiccolgurService {
    constructor(http) {
        this.http = http;
    }
    getQueue() {
...
NiccolgurService.ctorParameters = () => [
...
class TypeObject {
    constructor(id, desc, data) {
        this.id = id;
        this.desc = desc;
        this.data = data;
    }
}
TypeObject.ctorParameters = () => [
    { type: String },
    { type: String },
    { type: String }
];
class User {
    constructor(id, nickname, img, bio) {
        this.id = id;
...
const apiKey = '8dd0d0ce432b75b532e9fb563fa8fded';
const queue = 'https://guglielmofelici.github.io/niccolgur/data/queue.json';
const users = 'https://guglielmofelici.github.io/niccolgur/data/users.json';
const season = 'https://guglielmofelici.github.io/niccolgur/data/season.json';
const images = 'https://guglielmofelici.github.io/niccolgur/data/images/';
